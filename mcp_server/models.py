...
class CertificateParameters(BaseModel):
    AC_NO: str = Field(
        ..., description='Account No./PPO No.', examples=['T/AIS/XX or 123456789']
    )
    DOB: str = Field(
...
class PecerCertificatePostRequest(BaseModel):
...
class PecerCertificatePostResponse(BaseModel):
...
class PecerCertificatePostResponse1(BaseModel):
...
class PecerCertificatePostResponse2(BaseModel):
...
class PecerCertificatePostResponse3(BaseModel):
...
class PecerCertificatePostResponse4(BaseModel):
...
class PecerCertificatePostResponse5(BaseModel):
...
class PecerCertificatePostResponse6(BaseModel):
    error: Optional[Error6] = None
    errorDescription: Optional[ErrorDescription6] = None


class PrfndCertificatePostRequest(BaseModel):
    certificateParameters: Optional[CertificateParameters] = None
    consentArtifact: Optional[ConsentArtifactSchema] = None
    format: Format = Field(
        ..., description='The format of the certificate in response.'
...
class PrfndCertificatePostResponse(BaseModel):
...
class PrfndCertificatePostResponse1(BaseModel):
...
class PrfndCertificatePostResponse2(BaseModel):
...
class PrfndCertificatePostResponse3(BaseModel):
...
class PrfndCertificatePostResponse4(BaseModel):
...
class PrfndCertificatePostResponse5(BaseModel):
...
class PrfndCertificatePostResponse6(BaseModel):
